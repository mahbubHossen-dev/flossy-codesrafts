...
const SpecialServices = () => {
    ...
    return (
        ...
        <div className='w-full px-5 lg:px-8 xl:px-[8%] mt-24'>
            <HeaderSection header={'Our Dental Care Services'} description={'We offer a wide range of dental treatments designed to maintain, restore, and enhance your smile. From routine check-ups to advanced cosmetic procedures, our expert team is here to provide gentle and personalized care.'} />
