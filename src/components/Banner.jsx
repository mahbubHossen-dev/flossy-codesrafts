            ...
            <div className='flex justify-center items-center'>
                <div className='space-y-2.5'>
                    ...
                    <div className='flex gap-4'>
                        <div className='bg-[#0E82FD] rounded-lg text-lg text-white flex place-items-center gap-2 py-2 pl-2 pr-6'>
                            <FiPhoneCall className='p-2 bg-white text-black w-[35px] h-[35px] rounded-lg' />
                            <button className=''>  Get Started</button>
                        </div>
                        <div className='border-2 border-[#0E82FD] rounded-lg text-lg text-black flex place-items-center gap-2 py-2 pl-2 pr-6'>
                            <MdMedicalServices className='p-2 bg-[#0E82FD] text-white w-[35px] h-[35px] rounded-lg' />
                            <button className=''>  Get Started</button>
                        </div>
                    </div>
                </div>
